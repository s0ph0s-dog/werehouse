local TWITTER_URI_EXP = assert(
    re.compile(
        [[^(https?://)?(twitter\.com|vxtwitter\.com|fxtwitter\.com|x\.com|fixupx\.com|fixvx\.com|nitter\.privacydev\.net|twittervx\.com|xcancel\.com|girlcockx\.com|stupidpenisx\.com)/([A-z0-9_]+/)?status/([A-z0-9]+)]]
    )
)
